...
- [ ] LS-09 — **Анализ переговоров.** LLM (OpenRouter) поверх транскриптов. Разбит на
  под-проекты: **A — анализ в кабинете** (по кнопке: саммари + action items, персист;
  спека `docs/superpowers/specs/2026-07-27-cabinet-meeting-analysis-design.md`, план
  `docs/superpowers/plans/2026-07-27-cabinet-meeting-analysis.md`) — *в работе*;
  **B — live-саммари в расширении** (быстрая модель, эфемерно) — потом. Ключевые моменты/поиск —
  дальше.
