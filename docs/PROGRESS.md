...
- **LS-11 — нормальный логин в расширении** (убрать ручной токен; вход прямо в расширении,
  в идеале авто-подхват сессии кабинета) — по просьбе владельца. Затем LS-09 (анализ).
